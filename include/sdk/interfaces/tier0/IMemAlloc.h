...
public:
    ...
    {
        return Virtual::Get<void *(__thiscall *)(IMemAlloc*, const void*, std::size_t)>(this, 3)
                (this, p, size);
    }

    void Free(const void* p) { return Virtual::Get<void(__thiscall *)(IMemAlloc*, const void*)>(this, 5)(this, p); }
