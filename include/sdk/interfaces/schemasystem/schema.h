...
#ifdef CSGO2
        CSchemaClassInfo* class_info = nullptr;
        Virtual::Get<CSchemaClassInfo*(__thiscall*)(void*, CSchemaClassInfo**, const char*)>(this, 2)(this, &class_info, class_name);
...
private:
    ...
    CUtlTSHash<CSchemaClassBinding*> m_classes_; // 0x588
